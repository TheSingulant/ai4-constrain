...
**Next:** dedicated-context lifecycle and expanded authority-control work (not claimed complete here). Transaction-control scaffold (`ai4.transaction`) is branch work only and is not a 0.7.0 completeness claim.
